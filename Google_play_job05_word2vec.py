...
review_word = pd.read_csv('Google_play_data/google_play_cleaned_review_one_last.csv')
review_word.info()
...
embedding_model.save('./Google_play_models/word2vec_google_play_reviews_google.model')
